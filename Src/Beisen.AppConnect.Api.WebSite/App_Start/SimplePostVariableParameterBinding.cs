...
namespace Beisen.AppConnect.Api.WebSite
{
    public class SimplePostVariableParameterBinding : HttpParameterBinding
    {
        ...
        private object StringToType(string stringValue)
        {
            ...
            else if (Descriptor.ParameterType == typeof (short))
                value = short.Parse(stringValue, CultureInfo.CurrentCulture);
            else if (Descriptor.ParameterType == typeof (Int16))
                value = Int16.Parse(stringValue, CultureInfo.CurrentCulture);
